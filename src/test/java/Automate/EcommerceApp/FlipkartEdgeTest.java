...
public class FlipkartEdgeTest {
	WebDriver driver;

	@BeforeClass
	public void beforeClass() {
		System.setProperty(
				  "webdriver.edge.driver","C:\\Users\\ashuk\\Desktop\\jar_files\\95\\msedgedriver.exe"); 
	...
	public void loadImage() throws InterruptedException {
		...
		String url = "https://www.flipkart.com/apple-iphone-13-pink-256-gb/p/itmc5ee8ec6cd737?pid=MOBG6VF5XAMZ2FKX&lid=LSTMOBG6VF5XAMZ2FKX59OYTD&marketplace=FLIPKART&q=iPhone+13&store=tyy%2F4io&srno=s_1_8&otracker=search&otracker1=search&fm=organic&iid=726b6e9f-b204-4827-9ba9-f7a56703e8b8.MOBG6VF5XAMZ2FKX.SEARCH&ppt=hp&ppn=homepage&ssid=6achtrk6eo0000001666114588679&qH=c3d519be0191fbf8";
		driver.get(url);
		Thread.sleep(3000);
